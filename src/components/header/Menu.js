  ...
  return (
    ...
    >
      <div className="flex items-center h-[68px]">
        ...
        <Btn
          handleBtn={browseBtn}
          className="sm:hidden text-[14px] p-[2px] flex text-white items-center gap-1"
          name="Browse "
          icon={
            <svg
      ...
      <div className="  z-40 flex items-center justify-center sm:gap-5 relative">
        ...
        {location.pathname === "/browser/search" ? (
          ...
          <>
            <div className="text-[2rem] sm:p-2 p-1">
              <Btn
                icon={
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    ...
                    height="25"
                    fill="white"
                    className="bi bi-suit-heart sm:w-[25px] w-[19px]"
                    viewBox="0 0 16 16"
                  >
            ...
            <div className="dropdown dropdown-end">
              ...
              >
                <div className="rounded-lg sm:w-[38px] w-[28px]">
                  <img
                    alt="Tailwind CSS Navbar component"
                    src="https://occ-0-2164-1490.1.nflxso.net/dnm/api/v6/vN7bi_My87NPKvsBoib006Llxzg/AAAABTZ2zlLdBVC05fsd2YQAR43J6vB1NAUBOOrxt7oaFATxMhtdzlNZ846H3D8TZzooe2-FT853YVYs8p001KVFYopWi4D4NXM.png"
                  />
                </div>
              </div>
              <ul
                tabIndex={0}
                className="menu menu-sm dropdown-content bg-base-content rounded-box z-30 mt-3 w-40 p-2 shadow relative"
              >
                <li>
